    ...
    >
      ...
      <div className="relative z-10">
        <div className="mx-auto max-w-7xl">
          ...
          {/* Hero */}
          <div className="mb-12 border-2 border-white/10 bg-black/40 p-8 md:p-12">
            ...
            {units.map((unit) => {
              ...
              return (
                <Link
                  key={unit.title}
                  to={unit.path}
                  className={`group flex min-h-[320px] flex-col justify-between border-2 ${unit.accent} bg-black/40 p-8 transition-transform hover:-translate-y-1`}
                >
                  <div>
